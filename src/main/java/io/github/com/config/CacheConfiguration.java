...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.github.com.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.github.com.repository.UserRepository.USERS_BY_EMAIL_CACHE);
