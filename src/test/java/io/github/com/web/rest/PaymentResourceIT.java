package io.github.com.web.rest;

import static io.github.com.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import io.github.com.IntegrationTest;
import io.github.com.domain.Payment;
import io.github.com.repository.PaymentRepository;
import io.github.com.service.criteria.PaymentCriteria;
import io.github.com.service.dto.PaymentDTO;
import io.github.com.service.mapper.PaymentMapper;
...
class PaymentResourceIT {
    ...
    @Test
    @Transactional
    void getAllPaymentsByPaymentCategoryIsNotEqualToSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    void getAllPaymentsByPaymentCategoryIsInShouldWork() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    void getAllPaymentsByPaymentCategoryIsNullOrNotNull() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    void getAllPaymentsByPaymentCategoryContainsSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    void getAllPaymentsByPaymentCategoryNotContainsSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.dealerName(UPDATED_DEALER_NAME).paymentAmount(UPDATED_PAYMENT_AMOUNT);
